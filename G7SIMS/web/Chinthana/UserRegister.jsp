...
<body class="bg-gradient-primary hero">
    ...
    <div class="position-relative mt-120"></div>
    <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block"> <!<!-- bg-register-image -->
                        <div class="text-center">
                            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 15rem; padding: 6rem 5rem 2rem 5rem" src="images/G7Logo.png" alt="...">
                            <div class="text-center">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <div class="text-center">
                                <a class="small" href="/G7SIMS">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
